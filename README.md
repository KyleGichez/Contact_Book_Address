...
This software project has utilized the use of classes in python to manipulate python methods & objects and build a program to store all your personal contacts and email addresses safe.
